...
function Header({ hasLoaded, headerTitle, isOpen, closeNav, locale, route }) {
    ...
    return (_jsxs(TopHeader, { "$reveal": hasLoaded, children: [_jsxs(LogoLink, { as: Link, href: "/", locale: locale, onClick: backUp, children: [_jsx("span", { className: "sr-only", children: "acueducto" }), _jsx(Logo, {})] }), _jsx(HeaderTitle, { "$hide": isOpen, children: headerTitle })] }));
}
