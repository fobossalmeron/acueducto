...
export { Hoverable, NavLink, Registered, Policies, Social, BottomNav, NavList, NavWrapper, };
...
const BottomNav = styled.div `
  ...
  border-top: ${(props) => props.theme.stroke + ' solid ' + props.theme.colors.foreground_lowest};
  position: absolute;
  bottom: 0;
  padding: 2.5% 4%;
  width: 100%;
