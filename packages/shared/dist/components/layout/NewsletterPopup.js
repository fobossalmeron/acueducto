...
import { H4 } from '../shared/Dangerously';
import Cross from '../../assets/images/layout/cross.svg';
import es from '../../locales/es/newsletter.json';
import NamedForm from '../shared/NamedForm';
...
const NewsletterPopup = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(NewsWrapper, { "$clickable": showPopup, id: "NewsletterPopup", children: _jsxs(Border, { children: [_jsx(H4, { className: "max-w-[16ch]", children: newsletter.title }), _jsx("p", { children: newsletter.p }), _jsx(NamedForm, { id: "newsletter", onSubmit: onSubmit, text: newsletter, successMarkup: _jsx(Message, { success: true, children: newsletter.success.p }) }), _jsx(CrossContainer, { className: "card", onClick: unlockScreen, children: _jsx(Cross, {}) })] }) }), _jsx(Background, { "$visible": showPopup, onClick: unlockScreen })] }));
};
