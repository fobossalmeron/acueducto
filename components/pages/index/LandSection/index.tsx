...
export const LandSection = ({
  ...
  return (
    ...
    >
      <div className="xs:col-span-11 col-span-12 col-start-1 flex flex-col sm:col-span-12 sm:col-start-1 sm:items-center sm:text-center py-[10%]">
        <Fade cascade delay={0.4}>
          <h1
            className={`text-foreground text-[clamp(3.4rem,0.5rem+5vw,7rem)] leading-[100%] font-medium ${locale === 'en' ? 'max-w-[13ch] lg:max-w-[20ch]' : 'max-w-[15ch] lg:max-w-[20ch]'}`}
          >
            {heading}
          </h1>
          <span className="border-foreground-low text-foreground mt-1 inline-block w-fit -rotate-[1.65deg] rounded-full border-1 bg-[#1A3270]/60 px-5 pt-[0rem] pb-[0.6rem] text-[clamp(2.5rem,0.91rem+2.875vw,4.55rem)] font-medium">
            {pill}
          </span>
